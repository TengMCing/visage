...
There is another python-like OOP system in R called R6, which is also implemented using environment but in a different way. R6 is considered to be heavier than the visage OOP system, it provides many features that may not necessary needed by the user. However, if you are seeking a mature python-like OOP system at the moment, R6 is recommended. The visage OOP system is still experimental. 
